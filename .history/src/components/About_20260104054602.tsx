          ...
          >
            ...
            <p className="text-slate-300 leading-relaxed">
              <ul className="space-y-6 text-muted-foreground">
                <li>
                  <span className="italic text-foreground">Credentials</span>
                ...
                <li>
                  <span className="italic text">Awards & Recognition</span>
                  <ul className="mt-2 list-disc list-inside space-y-1">
                    <li>Huawei Future Star — 3 Years Consecutive</li>
                    <li>Huawei Asia Pacific Best Data Analyst — 2 Years Consecutive</li>
                    <li>Project Lead, 2025 World’s Most Impactful Telco Business Automation</li>
                  </ul>
                </li>
