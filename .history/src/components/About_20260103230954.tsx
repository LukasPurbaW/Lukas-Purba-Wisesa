        ...
        <div className="grid md:grid-cols-5 gap-12 items-center mb-20">
          ...
          >
            ...
            <p className="text-slate-300 leading-relaxed">
              <ul>  
              <li>A Certified Investment Consultant</li>
              <li>International Data Science Competition Winner</li>
              <li>Master Degree in AI and Machine Learning Developer</li><br/>
              
              <li>Huawei Future Star - 3 Years Consecutive </li>
              <li>Huawei Asia Pacific Best Data Analyst - 2 Years Consecutive </li>
              <li>Best Data Analyst Trainee and Group on International Huawei Data Training</li>
            ...
            <p className="text-slate-300 leading-relaxed">
              On 2025 I bring automation to life in biggest telco company in Indonesia, and the only use case that won two awards in one competition.
              Experienced in building data pipelines, data visualization, predictive modeling, and machine learning solutions to drive business growth and efficiency.
              Passionate about leveraging data to solve complex problems and deliver actionable insights.
            </p>
