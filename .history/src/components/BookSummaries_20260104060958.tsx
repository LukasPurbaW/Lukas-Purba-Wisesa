      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Easiest way to succeed is to learn from those who have walked the path before you. I believe in continuous learning and growth to consistently deliver my best.
          </p>
        </motion.div>
