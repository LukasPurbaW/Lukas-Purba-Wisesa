        ...
        <div className="grid md:grid-cols-5 gap-12 items-center mb-20">
          ...
          >
            ...
            <p className="text-slate-300 leading-relaxed">
              ...
              <li>2x International Data Science Competition Winner</li>
              <li>Master Degree in AI and Machine Learning Development</li><br/>
              
              <li>Huawei Future Star - 3 Years Consecutive </li>
              <li>Huawei Asia Pacific Best Data Analyst - 2 Years Consecutive </li>
              <li>Best Data Analyst Trainee and Group on International Huawei Data Training</li><br/>

              <li>International Automation Awards in Telco Industry</li>
              <li>10+ websites built with React, WordPress, and Tailwind CSS </li>
            ...
            <p className="text-slate-300 leading-relaxed">
              I am experienced in building data pipelines, data visualization, predictive modeling, and machine learning solutions to drive business growth and efficiency.
            </p>
