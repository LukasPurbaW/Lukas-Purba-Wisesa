...
export function About() {
  ...
  const strengths = [
    ...
    },
    {
      ...
      description: 'Extracting insight and deploying intelligent solutionsthat learn, adapt, providing real value'
    },
    {
      icon: Brain,
      title: 'Digital Transformation',
      description: 'From paper to platform, from manual to automated—seamless operations'
    }
  ];
