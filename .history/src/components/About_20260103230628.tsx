        ...
        <div className="grid md:grid-cols-5 gap-12 items-center mb-20">
          ...
          >
            ...
            <p className="text-slate-300 leading-relaxed">
              ...
              <li>AI and Machine Learning Developer with 5+ years of experience</li><br/>
              <li>3 Years Consecutive Huawei Future Star</li>
              <li>2 Years Consecutive Huawei Asia Pacific Best Data Analyst</li>
              <li>Best Data Analyst Trainee and Group on Internal Huawei Data Training</li>
