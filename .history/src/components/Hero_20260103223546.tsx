      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          <h2 className="text-muted-foreground">
            I Bring Digitalization to Every Business <br />
        ...
        >
          ...
          From building intuitive web platforms to scaling SaaS systems and applying AI-driven insights, I enable organizations to operate smarter, faster, and more efficiently.
        </motion.p>
