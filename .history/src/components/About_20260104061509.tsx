        ...
        <div className="grid md:grid-cols-5 gap-12 items-center mb-20">
          ...
          >
            <div className="aspect-square rounded-2xl overflow-hidden shadow-2xl">
              <ImageWithFallback
                src="https://unsplash.com/photos/landscape-photography-of-brown-mountains-and-river-uXTozY3CcQghttps://images.unsplash.com/photo-1537824598505-99ee03483384?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Lukas Purba Wisesa- Professional Portrait"
          ...
          >
            ...
            <p className="text-slate-300 leading-relaxed">
              <ul className="space-y-6">
                ...
                <li>
                  <h4 className="text-white">Awards & Recognition</h4>
                  <ul className="mt-2 list-disc list-inside space-y-1">
                ...
                <li>
                  <h4 className="text-white">Technical Experience</h4>
                  <ul className="mt-2 list-disc list-inside space-y-1">
                ...
                <li>
                  <h4 className="text-white">Northern Star</h4>
                  <ul className="mt-2 list-disc list-inside space-y-1">
                    <li>278 Million People in Indonesia, 8 Billion People in the World</li>
                    <li>I help businesses build automated and efficient digital operations to serve them all.</li>
                  </ul>
                </li>
