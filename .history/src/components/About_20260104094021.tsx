...
export function About() {
  ...
  const strengths = [
    ...
    },
    {
      ...
      description: 'Dashboard and Deploying intelligent solutions that learn, adapt, providing real value'
    },
    {
      icon: Brain,
      title: 'Digital Transformation',
      description: 'From paper to platform, from manual to automated—streamlining operations end-to-end'
    }
  ];
