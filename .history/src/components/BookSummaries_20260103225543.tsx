      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Curated insights from influential books that have shaped my thinking. 
            Each summary distills key concepts and practical takeaways for immediate application.
          </p>
        </motion.div>
